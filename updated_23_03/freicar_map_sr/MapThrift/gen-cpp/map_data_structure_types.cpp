...
void Lane::__set_junction_id(const int64 val) {
  this->junction_id = val;
}
...
uint32_t Lane::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 12:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->junction_id);
          this->__isset.junction_id = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Lane::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("junction_id", ::apache::thrift::protocol::T_I64, 12);
  xfer += oprot->writeI64(this->junction_id);
  xfer += oprot->writeFieldEnd();
...
void swap(Lane &a, Lane &b) {
  ...
  swap(a.junction_id, b.junction_id);
  swap(a.__isset, b.__isset);
}
...
Lane::Lane(const Lane& other105) {
  ...
  junction_id = other105.junction_id;
...
Lane& Lane::operator=(const Lane& other106) {
  ...
  junction_id = other106.junction_id;
...
void Lane::printTo(std::ostream& out) const {
  ...
  out << ", " << "junction_id=" << to_string(junction_id);
  out << ")";
}
...
void PointViz::__set_radius(const double val) {
  this->radius = val;
}
