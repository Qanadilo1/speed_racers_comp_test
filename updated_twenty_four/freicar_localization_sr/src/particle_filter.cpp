...
//        Eigen::Vector3f add_t(-7.754, 3.207, 0.0f);   // FREICAR2

      //  Eigen::Vector3f add_t(9.2f, -3.6f,0.0f);   // FREICAR2 AT JUNCTION TEST ROW
        Eigen::Vector3f add_t(spawn_x, spawn_y,0.0f);   // FREICAR2 AT JUNCTION TEST ROW


//        Eigen::Vector3f add_t(9.2f, -1.1f, 0.0f);    /// FREICAR2 JUNCTION
        t.translate(add_t);
        t.rotate(rot);
        p.transform = t;
    ...
    std::cout << "particles _initialised b4 " << particles_init_ << std::endl;
    particles_init_ = true;
    std::cout << "particles _initialised after " << particles_init_ << std::endl;
    }
