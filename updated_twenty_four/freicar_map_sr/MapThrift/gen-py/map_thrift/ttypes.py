...
class Point3D(object):
    ...
    def __init__(self, x=None, y=None, z=float(0),):
        self.x = x
        self.y = y
        self.z = z
...
class Lane(object):
    ...
    def __init__(self, lane_markings=None, dir=None, outgoing_connections=None, incoming_connections=None, type=None, points=None, width=None, id=None, handle_point=None, visibility=None, height=None, junction_id=None,):
        self.lane_markings = lane_markings
        self.dir = dir
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I64:
                    self.junction_id = iprot.readI64()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.junction_id is not None:
            oprot.writeFieldBegin('junction_id', TType.I64, 12)
            oprot.writeI64(self.junction_id)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
Point3D.thrift_spec = (
    ...
    (3, TType.DOUBLE, 'z', None, float(0), ),  # 3
)
...
Lane.thrift_spec = (
    ...
    (12, TType.I64, 'junction_id', None, None, ),  # 12
)
